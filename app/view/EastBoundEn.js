...
Ext.define('RTSBapp.view.EastBoundEn', {
    ...
    onMybutton19Tap: function (button, e, eOpts) {
        this.push(Ext.create("RTSBapp.view.EWGEN"), {
            title: "EWG"
        });
    },
    onMybutton20Tap: function (button, e, eOpts) {
        this.push(Ext.create("RTSBapp.view.EBGEN"), {
            title: "EBG"
        });
    },
    onMybutton21Tap: function (button, e, eOpts) {
        this.push(Ext.create("RTSBapp.view.EUGEN"), {
            title: "EUG"
        });
    }
});